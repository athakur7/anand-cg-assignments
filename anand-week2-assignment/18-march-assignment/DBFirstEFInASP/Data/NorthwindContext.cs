...
public partial class NorthwindContext : DbContext
{
    ...
    public virtual DbSet<VwCustomerOrderView> VwCustomerOrderViews { get; set; }

    public virtual DbSet<VwOrderLineItem> VwOrderLineItems { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=localhost,1433;Database=Northwind;User Id=sa;Password=Anand@123;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__CustomPr__3214EC07A7CE2849");
        ...
        modelBuilder.Entity<VwCustomerOrderView>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vw_CustomerOrderView");
        ...
        modelBuilder.Entity<VwOrderLineItem>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vw_OrderLineItems");
...
public DbSet<DBFirstEFInASP.Models.OrderQ> OrderQ { get; set; } = default!;
}
